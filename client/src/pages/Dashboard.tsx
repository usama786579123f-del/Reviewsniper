 ...
 * nothing to show yet. Uses the shared AppShell so sidebar navigation is
 * identical (and actually works) across every page.
 */
...
export default function DashboardPage() {
  ...
  return (
    <AppShell activeLabel="Dashboard" badges={{ "Crisis Leads": pagination?.total ?? 0 }}>
      <div className="dashboard-heading-row">
        <div>
          <p className="eyebrow">Overview</p>
          <h1>Dashboard</h1>
          <p className="dashboard-subtitle">{pagination && pagination.total > 0 ? "Live intelligence from your connected review source." : "Your live intelligence will appear here once a review source is connected."}</p>
        </div>
